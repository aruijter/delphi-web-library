...
const
  ...
  HTTP_FIELD_ACCESS_CONTROL_ALLOW_ORIGIN = 'Access-Control-Allow-Origin';
  HTTP_FIELD_ACCESS_CONTROL_ALLOW_METHODS = 'Access-Control-Allow-Methods';
  HTTP_FIELD_ACCESS_CONTROL_REQUEST_HEADERS = 'Access-Control-Request-Headers';
  HTTP_FIELD_ACCESS_CONTROL_ALLOW_HEADERS = 'Access-Control-Allow-Headers';
